...
kursori.execute("SELECT cityName from gameCountries where name='" + str(playerLocation) + "';")
cityname = kursori.fetchone()
city_name = cityname[0]

kursori.execute("SELECT airportName from gameCountries where name='" + str(playerLocation) + "';")
